...
function TiltCardTwo() {
    ...
    return (
        <motion.div 
          ...
          className="relative h-96 w-72 sm:w-[90%] z-[999]  rounded-xl bg-cover"
        >
            <img className='h-96 w-72 sm:w-[90%] object-cover rounded-xl' src="https://images.unsplash.com/photo-1600609293139-ea525a3edeec?q=80&w=1936&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
          <div
            style={{
